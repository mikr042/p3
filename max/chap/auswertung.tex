...
Regressionsgerade:
\begin{equation}
	0,10342\pm 0,00015 - 0,162\pm 0,005
\end{equation}

$R_{\infty} = 3,4479335\cdot 10^{15}$

Mit Gaußscher Fehlerfortpflanzung blabla plusminus
%muss noch durch c teilen, da man so die frequenz raus bekommt, wert kommt aber gut hin
