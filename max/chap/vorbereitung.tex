...
Zur Auswertung werden die Messwerte aus der ersten Aufgabe verwendet. Durch Auftragen der Energien der K$_\alpha$-Linien über die Kernladungszahlen der verschiedenen Elemente lässt sich also die Rydbergkonstante R$_\infty$ und die Abschirmungskonstante $\sigma_{2,1}$ mittels linearer Regression bestimmen.\\
Bei einer Steigung $m$ der Regressionsgeraden beträgt die Die Rydbergkonstante somit:
\begin{equation}
	R_{\infty} = \frac{4m^2}{3h}
	\label{eq:rhydberg}
\end{equation}
